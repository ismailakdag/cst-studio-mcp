...
def _build_patch_antenna(args: dict) -> str:
    ...
    if feed_type == "inset":
        ...
        port_vba = (
            ...
            .set_point("SetP1", probe_x, probe_y, 0)
            .set_point("SetP2", probe_x, probe_y, h)
...
def _build_dipole_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", 0, 0, -gap / 2)
        .set_point("SetP2", 0, 0, gap / 2)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_monopole_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", 0, 0, -0.5)
        .set_point("SetP2", 0, 0, 0)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_yagi_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", 0, -gap / 2, 0)
        .set_point("SetP2", 0, gap / 2, 0)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_helix_antenna(args: dict) -> str:
    ...
    sweep_vba = (
        ...
        .set("Curve", "helix_curves:wire_xsec")
        .set_bool("ProjectProfileToPathAdvanced", True)
        .call("Create")
    )
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", radius, 0, 0)
        .set_point("SetP2", radius, 0, -0.5)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_vivaldi_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", 0, -slot_min / 2, h)
        .set_point("SetP2", 0, slot_min / 2, h)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_slot_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", 0, -gnd_size / 2, -0.07)
        .set_point("SetP2", 0, -gnd_size / 2, 0)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_ifa_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", feed_x, 0, 0)
        .set_point("SetP2", feed_x, 0, ifa_height)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_pifa_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set_number("Impedance", 50)
        .set_point("SetP1", feed_x, 0, 0)
        .set_point("SetP2", feed_x, 0, pifa_height)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_spiral_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", p1x, p1y, 0)
        .set_point("SetP2", p2x, p2y, 0)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
...
def _build_bowtie_antenna(args: dict) -> str:
    ...
    port_vba = (
        ...
        .set("Type", "SParameter")
        .set_number("Impedance", 50)
        .set_point("SetP1", -gap / 2, 0, 0)
        .set_point("SetP2", gap / 2, 0, 0)
        .set_number("Radius", 0.5)
        .set_bool("Monitor", True)
        .call("Create")
    )
